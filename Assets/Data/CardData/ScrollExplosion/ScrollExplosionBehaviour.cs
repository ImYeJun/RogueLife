...
namespace Battle.Cards.Behaviours
{
    ...
    public class ScrollExplosion : CardBattleBehaviour<SingleEnemyCardTarget, CompositeCardTarget>
    {
        ...
        private ScrollExplosion(ICardBehaviourOwner owner, CardTargetType targetType, CardTargetType reflectionTargetType)
        : base(owner, targetType, reflectionTargetType) { }
        
        public override CardBattleBehaviour Clone(ICardBehaviourOwner owner)
        {
            return new ScrollExplosion(owner, targetType, reflectionTargetType);
        }
