...
namespace Battle.Cards.Behaviours
{
    ...
    public class ProteinSupplement : CardBattleBehaviour<NoneCardTarget, PlayerCardTarget>
    {
        ...
        private ProteinSupplement(ICardBehaviourOwner owner, CardTargetType targetType, CardTargetType reflectionTargetType)
        : base(owner, targetType, reflectionTargetType) {}
        
        public override CardBattleBehaviour Clone(ICardBehaviourOwner owner)
        {
            return new ProteinSupplement(owner, targetType, reflectionTargetType);
        }
