...
namespace Battle.Cards.Behaviours
{
    ...
    {   
        ...
        private DoubleOrNothing(ICardBehaviourOwner owner, CardTargetType targetType, CardTargetType reflectionTargetType)
        : base(owner, targetType, reflectionTargetType) { }
        
        public override CardBattleBehaviour Clone(ICardBehaviourOwner owner)
        {
            return new DoubleOrNothing(owner, targetType, reflectionTargetType);
        }
