...
namespace Battle.Cards.Behaviours
{
    ...
    public class StoneOfDavid : CardBattleBehaviour<CompositeCardTarget, CompositeCardTarget>
    {
        ...
        public StoneOfDavid() {}
        private StoneOfDavid(ICardBehaviourOwner owner, CardTargetType targetType, CardTargetType reflectionTargetType) 
        : base(owner, targetType, reflectionTargetType) { }

        public override CardBattleBehaviour Clone(ICardBehaviourOwner owner)
        {
            return new StoneOfDavid(owner, targetType, reflectionTargetType);
        }
