...
namespace Battle.Cards.Behaviours
{
    ...
    public class RecallAnything : CardBattleBehaviour<NoneCardTarget, NoneCardTarget>
    {
        ...
        private RecallAnything(ICardBehaviourOwner owner, CardTargetType targetType, CardTargetType reflectionTargetType) 
        : base(owner, targetType, reflectionTargetType) { }

        public override CardBattleBehaviour Clone(ICardBehaviourOwner owner)
        {
            return new RecallAnything(owner, targetType, reflectionTargetType);
        }
