...
namespace Battle.Cards.Behaviours
{
    ...
    public class RussianRoulette : CardBattleBehaviour<CompositeCardTarget, CompositeCardTarget>
    {
        ...
        private RussianRoulette(ICardBehaviourOwner owner, CardTargetType targetType, CardTargetType reflectionTargetType) 
        : base(owner, targetType, reflectionTargetType) { }

        public override CardBattleBehaviour Clone(ICardBehaviourOwner owner)
        {
            return new RussianRoulette(owner, targetType, reflectionTargetType);
        }
