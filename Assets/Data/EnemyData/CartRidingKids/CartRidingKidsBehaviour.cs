...
namespace Battle.Enemies.Behaviours
{
    ...
    {
        private const string FIRST_ACTION = "Enemy_CartRidingKids_Behavior_0";
        private const string SECOND_ACTION = "Enemy_CartRidingKids_Behavior_1";
        private const string THIRD_ACTION = "Enemy_CartRidingKids_Behavior_2";
