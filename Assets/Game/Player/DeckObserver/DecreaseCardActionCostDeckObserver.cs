...
{
    [Serializable]
    public class DecreaseCardActionCost : IDeckObserver
    {
        ...
        public void OnCardEquipped(Card card)
        {
            ...
            {
                UnityEngine.Debug.LogWarning("[DecreaseCardActionCost] The given card is already being observed");
                return;
            }
        ...
        public void OnCardRemoved(Card card)
        {
            ...
            UnityEngine.Debug.LogWarning("[DecreaseCardActionCost] The given card is not  being observed");
        }
