...
public class IncreaseCardActionCost : IBattleAction
{
    private ICardBehaviourOwner cardBehaviourOwner;
    private int amount;
    private BattleScope scope;

    public IncreaseCardActionCost(ICardBehaviourOwner cardBehaviourOwner, int amount, BattleScope scope)
    {
    ...
    public void Execute(BattleContext context)
    {
        ...
        switch (scope)
        {
            ...
            case BattleScope.BATTLE:
                ...
                break;
            default:
                throw new InvalidOperationException($"[IncreaseCardActionCost] {scope} is no valid.");
        }
    }
}